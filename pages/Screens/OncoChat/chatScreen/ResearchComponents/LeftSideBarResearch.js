...
function LeftSideBarResearch({
  ...
  const handleDeleteClick = async (chat, event) => {
    ...
    try {
      const response = await axios.delete(
        `${process.env.MERCURIAL_BACKEND_API}/delete-research-chat-history/${chat._id}`,
        {
          headers: {
  ...
  return (
    <div className="sidebar-content">
      ...
      <hr
        className="divider"
        style={{ margin: "1.5rem 0 0 0", color: "white" }}
      />
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-12 p-0">
            <div className="left-sidebar-title-container">
              <h6>Research Chat history</h6>
            </div>
          </div>
          <div className="col-lg-12 p-0">
              ...
              {chats.map((chat, index) => (
                ...
                >
                  <div className="chats-text-container">
                    <p>
                      {chat.researchChatHistory &&
                        chat.researchChatHistory[0] &&
                        chat.researchChatHistory[0].content}
                    </p>
                  </div>
...
export default LeftSideBarResearch;
